...
- **Run timestamp**: 2026-05-20T20:39:25Z UTC
...
|---|---|---|---|
| Apogee altitude error | <= 10 m | 20.00 m | FAIL |
...
- Details: truth_apogee=609.86 m @ 12.197 s; est_apogee=629.86 m @ 12.197 s; dAlt=20.000 m (<=10.0), dT=0.000 s (<=0.50)
...
- Details: sensor[09920bf3 vs 09920bf3] estimate[04c9b072 vs 04c9b072]

### sanity -- PASS

- Details: nan_signals={}; inf_signals={}; runtime=25.00 s (<=300)

## Sanity checks

- NaN signals: 
- Inf signals: 
- Wall-clock runtime: 25.00 s (budget 300 s) -> PASS
...
- **apogee**: truth_apogee=609.86 m @ 12.197 s; est_apogee=629.86 m @ 12.197 s; dAlt=20.000 m (<=10.0), dT=0.000 s (<=0.50)
